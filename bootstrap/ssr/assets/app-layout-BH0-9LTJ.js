...
import { B as Button, A as AppLogoIcon } from "./app-logo-icon-Dbm1VCN0.js";
...
function NavMain({ items = [] }) {
  ...
  return /* @__PURE__ */ jsxs(SidebarGroup, { className: "px-2 py-0", children: [
    ...
    /* @__PURE__ */ jsx(SidebarMenu, { children: items.map((item) => /* @__PURE__ */ jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsx(SidebarMenuButton, { asChild: true, isActive: page.url.startsWith(item.href), tooltip: { children: item.title }, children: /* @__PURE__ */ jsxs(Link, { href: item.href, prefetch: true, children: [
