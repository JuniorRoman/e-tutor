...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(`./pages/${name}.tsx`, /* @__PURE__ */ Object.assign({ "./pages/auth/confirm-password.tsx": () => import("./assets/confirm-password-fm6Qgoue.js"), "./pages/auth/forgot-password.tsx": () => import("./assets/forgot-password-CYMYjfNj.js"), "./pages/auth/login.tsx": () => import("./assets/login-ByFFN3H2.js"), "./pages/auth/register.tsx": () => import("./assets/register-LjrvPk_a.js"), "./pages/auth/reset-password.tsx": () => import("./assets/reset-password-BWTpXNoP.js"), "./pages/auth/verify-email.tsx": () => import("./assets/verify-email-Cq3drA4p.js"), "./pages/dashboard.tsx": () => import("./assets/dashboard-BUeojmZa.js"), "./pages/settings/appearance.tsx": () => import("./assets/appearance-z3Ahaaup.js"), "./pages/settings/password.tsx": () => import("./assets/password-Dhr8fN2m.js"), "./pages/settings/profile.tsx": () => import("./assets/profile-DJx0BEPi.js"), "./pages/welcome.tsx": () => import("./assets/welcome-BLkflVjx.js") })),
    setup: ({ App, props }) => {
